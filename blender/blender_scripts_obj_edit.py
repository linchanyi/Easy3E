...
parser.add_argument("--random_ortho", type=int, default=0)
parser.add_argument("--device", type=str, default="CUDA")
parser.add_argument("--subject_width",type = str, default = "")
...
#     fill_light.rotation_euler = (-0.05, 0.0, 0.0)
    ...
    normal_file_output.base_path = os.path.join(args.output_dir, 'normal')
